...
from lib.model.transformer import Transformer, mask_not_pad
from lib.model.utils import LabelSmoothingLoss
...
class NextWordPrediction(BasicLM):
    ...
    def train(self):
        ...
        self.loss = LabelSmoothingLoss(ignore_index=0)
