...
from lib.model.layers.embedding import PositionalEmbedding
...
class Transformer(nn.Module):
    ...
    def forward(self, inp_batch, out_batch):
        ...
        # Decoder
        trg_mask = get_dec_mask(out_batch)
        # [batch size, maxlen, d_m]
        ...
        rst = F.log_softmax(self.affine(dec))
        return rst
    ...
    def predict(self, inp_batch):
        ...
        # => [batch size, maxlen, vocab_size]
        rst = F.log_softmax(self.affine(enc))
        return rst
